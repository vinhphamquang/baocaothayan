      ...
      <div className="p-6">
        ...
        <div className="mb-3">
          ...
          <p className="text-sm text-gray-500 capitalize">
            {car.type === 'electric' ? 'Xe điện' : car.type === 'hybrid' ? 'Xe hybrid' : 'Xe xăng'} • {car.brand}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>{car.specifications.power || 'N/A'}</span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
            <Users className="h-4 w-4 mr-2 text-blue-500" />
            <span>{car.specifications.seatingCapacity || 5} chỗ</span>
          </div>
        </div>
